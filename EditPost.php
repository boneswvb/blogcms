...
if (isset($_POST["Submit"])) {
  ...
  if (empty($PostTitle)) {
    ...
    //  update data in the database for selected id
    ...
    if ($Execute) {
      $_SESSION["SuccessMessage"] = "Blog updated successfully!";
      Redirect_to("Posts.php");
    } else {
    ...
    <div class="row">
      <div class="offset-lg-1 col-lg-10" style="min-height: 400px">
        ...
        while ($DataRows = $stmt->fetch()) {
          $TitletToBeUpdated = $DataRows['title'];
            ...
            <div class="card-body bg-dark">
              <div class="form-group">
                ...
                <input class="form-control mb-2" type="text" name="PostTitle" id="title" placeholder="Type title here"
                  value="<?php echo $TitletToBeUpdated; ?>">
              </div>
              <div class="form-group">
              ...
              <img class="my-2" src="uploads/<?php echo $ImageToBeUpdated; ?>" alt="<?php echo $TitltToBeUpdated; ?>"
              ...
              <div class="form-group">
                <label for="Post" class="FieldInfo">Post:
                  <textarea class="form-control" name="PostDescription" id="Post" cols="100" rows="8">
